...
Gates (Linux cloud, Godot 4.6.2): `front_end` 29/0 with empty stderr; parse check clean; `gdformat -l 110 --check` clean. The full `ci_gates.py` run is logged with F-P4-03-corners, which is based on this branch.
