...
**Astra** (GPT-6 Astra: owner-assigned content/integration), **Gemini** (3.8 Flash: tools, mechanical ports, content, docs),
**Sonnet** (Claude Sonnet 5: owner-assigned art/content), **owner** (decisions, playtests, downloads).
...
| Look-9 | NFSU nights: wet-road specular streaks, teal/blue-vs-amber colour tuned against NFSU frames, glowing trackside structures (no black void), speed blur | Sonnet | | done (reviewed; merged) | rb/look-9-nights |
...
| Look-9 | NFSU nights: wet-road specular streaks, teal/blue-vs-amber colour tuned against NFSU frames, glowing trackside structures (no black void), speed blur | Sonnet | | done (reviewed; merged) | rb/look-9-nights; not merged, gates/features verification left for a follow-up session (see REBUILD-LOG "PAUSED Look-9") |
| Look-10 | Forest floor and roadside vegetation: undergrowth cards, 3+ deciduous species, Nordschleife hedges/verge grass | Sonnet | Look-6 | done (reviewed; merged with fix) | rb/look-10-undergrowth; implementation complete and pushed, gates/screenshots/DONE entry/PR left for a follow-up session (see REBUILD-LOG "PAUSED Look-10") |
...
| P6-02b | Complete the full Nordschleife TrackAsset, all remaining sections | Gemini (content/tools only), Claude review | P6-02a | open | Owner priority for 2026-09-26 |
| CHI-01 | Chicago river-and-lake street circuit: must drive Lake Shore Drive, Michigan Avenue, Lower Wacker and Upper Wacker; route must show the Chicago River, Lake Michigan, the Bean, Willis Tower and Navy Pier | Astra (content/integration), Claude review | P3-02c, P3-03 | review: Claude | `rb/CHI-01-chicago` — complete, UNMERGED per owner. Initial v1 geometry: 8.12 km; 37/37 gates, 6/6 perf suites, features 77/77, Mac export/smoke PASS, Jev COMPLETE 0.94. Nighttime refinement: lit landmarks/ceiling fixtures, 27 Chicago checks, exported-pack toggle test; Jev COMPLETE 0.93. Further v2 route and visual pass (2026-09-25): 8.161 km; Wacker riverfront bends, added Chicago landmarks/bridges, CC0 PBR surfaces and animated water; 33/33 Chicago geometry gate, 6/6 targeted laps and refreshed baselines; Mac preview refreshed. Original v1 measurements are retained as historical evidence. See DONE CHI-01 and docs/rebuild/chicago/ |
| CHI-03 | Chicago reference board, visual comparison captures and reflective animated water | Sol | CHI-01 | review: Claude | `rb/CHI-03-refs-water` |
| AUDIO-01 | Polish racing sound design: engine, transmission, tyre, road-surface, wind and impact balance and transitions | Sol | P4-vis | open | Owner-requested; target 2026-09-26 |
| FFB-01 | Add and tune force feedback for supported steering wheels, including clipping, centering and road/kerb cues | Claude | P4-core | open | Owner-requested; target 2026-09-26 |
| SPA-02 | Spa follow-up polish: close remaining runoff/gravel and Eau Rouge/Raidillon kerb-profile gaps, then review drivability and presentation | Astra (content), Claude review | P6-01-polish | open | Owner-requested; target 2026-09-26; begin after the current P6-01-polish review resolves |
