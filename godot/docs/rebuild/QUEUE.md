...
| P7-01b | Move the SURF table out of track3d.gd; fold car.gd into CarBody; rewrite aids_simcade and flat_equivalence without CarModel; delete track.gd, track3d.gd, tests/dynamics.gd and baseline.json | Claude | P7-01a | next | |
