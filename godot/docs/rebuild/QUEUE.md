...
| CHI-01 | Chicago river-and-lake street circuit: must drive Lake Shore Drive, Michigan Avenue, Lower Wacker and Upper Wacker; route must show the Chicago River, Lake Michigan, the Bean, Willis Tower and Navy Pier | Astra (content/integration), Claude review | P3-02c, P3-03 | claimed: Codex | Owner-requested; target 2026-09-26. Block out a closed lap and verify landmark sightlines; use game-only ramp connectors only where needed to join the real road sections |
